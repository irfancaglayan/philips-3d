...
input_video_path = 'depth_crafter/birds_video_combined.mp4'
output_video_path = 'depth_crafter/birds_first_frame_header_v3d.mp4'
...
# Open the video capture and read the first frame
...
while cap.isOpened():
    ...
    # Embed header only in the first frame
    if frame_count == 0:
...
print(f"Header embedded into the first frame and saved to {output_video_path}")